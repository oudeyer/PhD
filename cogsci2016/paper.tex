...
\section{Methods}
	...
	\subsection{Environment}
		...
		\begin{figure}[h]
			...
			\includegraphics[width=2.8cm]{./include/mvt-33.pdf}
			\includegraphics[width=2.8cm]{./include/mvt-49.pdf}
			\caption{Exemple of one mouvement}
			\label{mvt}
		\end{figure}
...
\section{Results}
	...
	\begin{figure*}[ht]
		\centering
		\subfloat{\includegraphics[width=14cm]{./include/xp1-explo-legend.eps}}\\
		\vspace{-0.3cm}
		\subfloat[$Hand$]{\includegraphics[width=3.5cm]{./include/xp1-explo-hand.eps}}
		\subfloat[$Stick_1$]{\includegraphics[width=3.5cm]{./include/xp1-explo-stick_1.eps}}
		\subfloat[$Stick_2$]{\includegraphics[width=3.5cm]{./include/xp1-explo-stick_2.eps}}
		\subfloat[$Object$]{\includegraphics[width=3.5cm]{./include/xp1-explo-obj.eps}}
		\subfloat[$Boxes$]{\includegraphics[width=3.5cm]{./include/xp1-explo-box.eps}}
