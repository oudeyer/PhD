...
\section{Discussion}
	...
	\subsection{F-RGB vs H-RGB-P-AMB vs H-RGB-GR-AMB}
	
		Results show different structures of behavior evolution in those 3 conditions.
		
		Results show that random model babbling and active model babbling both show overlapping waves structure in the evolution of the three behaviors, 
