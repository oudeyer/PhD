...
\section{Results}
	...
	\begin{figure}[ht]
		\centering
		\subfloat{\includegraphics[width=4.5cm]{./include/H-RGB-P-AMB-log9-interests-100000.pdf}}
		\hspace{-0.7cm}
		\subfloat{\includegraphics[width=4.5cm]{./include/H-RGB-P-AMB-log9-obj-explo.pdf}}
	...
	\subsubsection{Structure of the evolution of behaviours}
		...
		\begin{figure*}[ht]
			...
			\hspace{-0.4cm}
			\includegraphics[width=5.5cm]{./include/H-RGB-GR-AMB-log15-events-100000.pdf}
			\hspace{-0.4cm}
			\includegraphics[width=5.5cm]{./include/H-RGB-P-AMB-log8-events-100000.pdf}
