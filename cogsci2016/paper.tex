...
\section{Methods}
	...
	\subsection{Learning architectures}
		...
		\subsubsection{Hierarchical architectures}
			...
			The actual outcome $s$ in the sensory space of the module, associated to $m$ might be very different from $s_g$ as this goal might be unreachable, or because lower-level modules are not mature enough for that goal.
			...
			In condition H-RGB-P-AMB, the choice of module is proportional to their interest (probabilities are proportional to interest but with $\epsilon=10\%$ of random choice). 
			In condition H-RGB-GR-AMB, the choice of module is greedy (module with maximum interest) but also with $\epsilon=10\%$ of random choice.
...
\section{Results}
	...
	\begin{figure*}[ht]
		\centering
		\subfloat[H-RGB-GR-AMB]{\includegraphics[width=7cm]{./include/H-RGB-GR-AMB-log15-events-100000.pdf}}
		\subfloat[H-RGB-P-AMB]{\includegraphics[width=7cm]{./include/H-RGB-P-AMB-log8-events-100000.pdf}}
