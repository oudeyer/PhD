...
\section{Methods}
	...
	\subsection{Learning Architectures}
		...
		\subsubsection{Hierarchical Architectures}
			...
			%\footnote{Other work have used a simple hierarchy of two sensorimotor models for object manipulation: \cite{forestier2015} and \cite{unifying}.}
...
\section{Results}
	...
	\subsubsection{Structure of the Evolution of Behaviours}
		...
		In the first category ($hand$) are movements of the arm that did not grab any stick and thus did not move the out-of-reached object.
		The second category ($stick$) are movements that did grab one of the two sticks but did not touch the object with it.
		The third category ($object$) contains the movements where both a stick was grabbed and the object was moved by the stick.
		...
		behaviours of categories $stick$ and $object$ increase quickly from $0$ to more than $10\%$ (potentially after an initial phase with a steady low value), 
	...
	\subsubsection{Exploration Efficiency}
		...
		%Also, H-GR-AMB shows lower exploration of all spaces than H-P-AMB ($p<0.01$).
		...
		\begin{figure*}[ht]
			...
			\vspace{-0.4cm}
			\subfloat[$Hand$]{\includegraphics[height=5.5cm]{./include/xp1-explo-hand.pdf}}
			\subfloat[$Stick_1$]{\includegraphics[height=5.5cm]{./include/xp1-explo-stick_1.pdf}}
			\subfloat[$Stick_2$]{\includegraphics[height=5.5cm]{./include/xp1-explo-stick_2.pdf}}
			\subfloat[$Object$]{\includegraphics[height=5.5cm]{./include/xp1-explo-obj.pdf}}
			\subfloat[$Boxes$]{\includegraphics[height=5.5cm]{./include/xp1-explo-box.pdf}}
