...
\section{Results}
	...
	\subsection{Structure of the evolution of behaviors}
		...
		Also, the median number of abrupt changes across trials for each condition are reported in the same table (as the sum of steady changes of more than $10\%$ in the three behaviors).
