...
\section{Hierarchically structured exploration}
	...
	\subsection{Experiment 1: Results}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log8-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log8-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log8-events.png}}
			\subfloat[Object exploration]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log8-obj-explo.png}}
			\caption{Competences, interests, events and object exploration using H0 with Random Goal Babbling}
			\label{resH0GB}
		\end{figure*}
		
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log3-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log3-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log3-events.png}}
			\subfloat[Object exploration]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log3-obj-explo.png}}
			\caption{Competences, interests, events and object exploration using H1 with Random Goal Babbling}
			\label{resH1GB}
		\end{figure*}
		
		%\begin{figure*}[!t]
			%\centering
			%\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp1-event-tool_1.png}}
			%\subfloat[Object]{\includegraphics[width=4cm]{./include/xp1-event-obj.png}}
			%\subfloat[Box 1]{\includegraphics[width=4cm]{./include/xp1-event-box_1.png}}\\
			%\subfloat[Box 2]{\includegraphics[width=4cm]{./include/xp1-event-box_2.png}}
			%\subfloat[Box 3]{\includegraphics[width=4cm]{./include/xp1-event-box_3.png}}
			%\caption{Number of touch of tool, object and boxes for each 10000 iterations' bin.}
			%\label{res_xp1_events}
		%\end{figure*}
		
		\begin{figure*}[!t]
			\centering
			\subfloat[Hand]{\includegraphics[width=4cm]{./include/xp1-explo-hand.png}}
			\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp1-explo-stick_1.png}}
			\subfloat[Object]{\includegraphics[width=4cm]{./include/xp1-explo-obj.png}}
			\subfloat[Box]{\includegraphics[width=4cm]{./include/xp1-explo-box.png}}
			\caption{Exploration of sensory spaces.}
			\label{res_xp1_explo}
		\end{figure*}
		
		
		See Fig. \ref{resH0GB}, \ref{resH1GB}, \ref{res_xp1_explo}.
...
\section{Choice of module to explore}
	...
	\subsection{Experiment 2: Results}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log7-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log7-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log7-events.png}}
			\subfloat[Object exploration]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log7-obj-explo.png}}
		...
		%\begin{figure*}[!t]
			%\centering
			%\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp2-event-tool_1.png}}
			%\subfloat[Object]{\includegraphics[width=4cm]{./include/xp2-event-obj.png}}
			%\subfloat[Box 1]{\includegraphics[width=4cm]{./include/xp2-event-box_1.png}}\\
			%\subfloat[Box 2]{\includegraphics[width=4cm]{./include/xp2-event-box_2.png}}
			%\subfloat[Box 3]{\includegraphics[width=4cm]{./include/xp2-event-box_3.png}}
			%\caption{Number of touch of tool, object and boxes for each 10000 iterations' bin.}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Hand]{\includegraphics[width=4cm]{./include/xp2-explo-hand.png}}
			\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp2-explo-stick_1.png}}
			\subfloat[Object]{\includegraphics[width=4cm]{./include/xp2-explo-obj.png}}
			\subfloat[Box]{\includegraphics[width=4cm]{./include/xp2-explo-box.png}}
			\caption{Exploration of sensory spaces.}
			\label{res_xp2_explo}
		\end{figure*}
...
\section{Top-Down Guidance}
	...
	%\paragraph{Experiment 3: How can high-level tasks guide the exploration of lower-level ones ?}
	...
	\subsection{Experiment 3: Results}
		...
		%\begin{figure*}[!t]
			%\centering
			%\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp3-event-tool_1.png}}
			%\subfloat[Object]{\includegraphics[width=4cm]{./include/xp3-event-obj.png}}
			%\subfloat[Box 1]{\includegraphics[width=4cm]{./include/xp3-event-box_1.png}}\\
			%\subfloat[Box 2]{\includegraphics[width=4cm]{./include/xp3-event-box_2.png}}
			%\subfloat[Box 3]{\includegraphics[width=4cm]{./include/xp3-event-box_3.png}}
			%\caption{Number of touch of tool, object and boxes for each 10000 iterations' bin.}
			%\label{res_xp3_events}
		%\end{figure*}
		
		\begin{figure*}[!t]
			\centering
			\subfloat[Hand]{\includegraphics[width=4cm]{./include/xp3-explo-hand.png}}
			\subfloat[Tool]{\includegraphics[width=4cm]{./include/xp3-explo-stick_1.png}}
			\subfloat[Object]{\includegraphics[width=4cm]{./include/xp3-explo-obj.png}}
			\subfloat[Box]{\includegraphics[width=4cm]{./include/xp3-explo-box.png}}
			\caption{Exploration of sensory spaces.}
			\label{res_xp3_explo}
		\end{figure*}
...
\section{Choice of tool to use}
	...
	\subsection{Experiment 4: Results}
		...
		%\begin{figure*}[!t]
			%\centering
			%\subfloat[Tool1]{\includegraphics[width=4cm]{./include/xp4-event-tool_1.png}}
			%\subfloat[Tool2]{\includegraphics[width=4cm]{./include/xp4-event-tool_2.png}}
			%\subfloat[Object]{\includegraphics[width=4cm]{./include/xp4-event-obj.png}}\\
			%\subfloat[Box 1]{\includegraphics[width=4cm]{./include/xp4-event-box_1.png}}
			%\subfloat[Box 2]{\includegraphics[width=4cm]{./include/xp4-event-box_2.png}}
			%\subfloat[Box 3]{\includegraphics[width=4cm]{./include/xp4-event-box_3.png}}
			%\caption{Number of touch of tools, object and boxes for each 10000 iterations' bin.}
			%\label{res_xp4_events}
		%\end{figure*}
		
		\begin{figure*}[!t]
			\centering
			\subfloat[Hand]{\includegraphics[width=4cm]{./include/xp4-explo-hand.png}}
			\subfloat[Tool1]{\includegraphics[width=4cm]{./include/xp4-explo-stick_1.png}}
			\subfloat[Tool2]{\includegraphics[width=4cm]{./include/xp4-explo-stick_2.png}}\\
			\subfloat[Object]{\includegraphics[width=4cm]{./include/xp4-explo-obj.png}}
			\subfloat[Box]{\includegraphics[width=4cm]{./include/xp4-explo-box.png}}
			\caption{Exploration of sensory spaces.}
			\label{res_xp4_explo}
		\end{figure*}
