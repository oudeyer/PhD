...
\section{Results}
	...
	\subsection{Flat vs Hierarchy}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[]{\includegraphics[width=8cm]{./include/competences_H0.png}}
			\subfloat[]{\includegraphics[width=8cm]{./include/interests_H0.png}}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[]{\includegraphics[width=8cm]{./include/competences_H1.png}}
			\subfloat[]{\includegraphics[width=8cm]{./include/interests_H1.png}}
