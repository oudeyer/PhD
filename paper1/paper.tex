...
\section{Hierarchically structured exploration}
	...
	\subsection{Experiment 1: Results}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log2-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log2-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log2-events.png}}
			\subfloat[Object exploration]{\includegraphics[width=4cm]{./include/xp1-H0-GB-log2-obj-explo.png}}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log1-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log1-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log1-events.png}}
			\subfloat[Object exploration]{\includegraphics[width=4cm]{./include/xp1-H1-GB-log1-obj-explo.png}}
...
\section{Choice of module to explore}
	...
	\subsection{Experiment 2: Results}
		...
		\begin{figure*}[!t]
			\centering
			\subfloat[Competences]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log1-competences.png}}
			\subfloat[Interests]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log1-interests.png}}
			\subfloat[Events]{\includegraphics[width=4cm]{./include/xp2-H1-GB-log1-events.png}}
...
\section{Top-Down Guidance}
	...
	%\paragraph{Experiment 3: How can high-level tasks guide the exploration of lower-level ones ?}
		...
		\begin{itemize}
			...
			%\item Condition BST: balance between self-interest and top-down points (one parameter).
